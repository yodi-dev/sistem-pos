                        ...
                        <form>
                            <div class="mt-4">
                                ...
                                <select wire:change="updateSelectedSupplier" wire:model="selectedSupplier"
                                    ...
                                    <?php $__currentLoopData = $chooseSuppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['selectedSupplier'];
...
</div><?php /**PATH C:\Users\asus\Herd\sistem-pos\resources\views\livewire\dashboard\choose-supplier.blade.php ENDPATH**/ ?>