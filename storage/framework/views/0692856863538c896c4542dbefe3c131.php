                ...
                <div class="mt-3 mb-4 text-center sm:mt-0  sm:text-left">
                    <div class="mt-2 text-base-content">
                        ...
                        <ul class="list-disc list-inside mb-4">
                            <?php if($assignedSuppliers->isEmpty()): ?>
                                <p>Belum ada supplier</p>
                            <?php else: ?>
                                <?php $__currentLoopData = $assignedSuppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</div><?php /**PATH C:\Users\asus\Herd\sistem-pos\resources\views\livewire\product\supplier.blade.php ENDPATH**/ ?>