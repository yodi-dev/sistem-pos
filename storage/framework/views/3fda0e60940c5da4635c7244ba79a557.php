...
<?php $component = Mary\View\Components\Card::resolve(['title' => 'Data Supplier','shadow' => true,'separator' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['class' => 'text-neutral bg-base-200']); ?>
            ...
            <?php if($isModalOpen): ?>
                <?php echo $__env->make('livewire.supplier.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
                        ...
                        <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="<?php echo e($loop->odd ? 'bg-base-300' : 'bg-base-100'); ?>">
                                ...
                                <td class="flex justify-center">
                                    <button wire:click="edit(<?php echo e($supplier->id); ?>)"
...
</div><?php /**PATH C:\Users\asus\Herd\sistem-pos\resources\views\livewire\supplier\supplier-manager.blade.php ENDPATH**/ ?>