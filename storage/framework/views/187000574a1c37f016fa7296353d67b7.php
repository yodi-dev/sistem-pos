...
<?php endif; ?>
    <div class="card w-96 bg-base-200 shadow-lg rounded-lg">
        <div class="card-body">
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'form.email','id' => 'email','class' => 'block mt-1 w-full rounded-md','type' => 'email','name' => 'email','required' => true,'autofocus' => true,'autocomplete' => 'username']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'btn w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn w-full']); ?>
                        <?php echo e(__('Masuk')); ?>
...
</div><?php /**PATH C:\Users\asus\Herd\sistem-pos\resources\views\livewire/pages/auth/login.blade.php ENDPATH**/ ?>