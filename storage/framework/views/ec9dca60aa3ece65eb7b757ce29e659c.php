            ...
            <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="mt-3 mb-4 text-center sm:mt-0  sm:text-left">
                    <h2 class="text-2xl leading-6 font-medium text-neutral" id="modal-title">
                        <?php echo e($category_id ? 'Edit Kategori' : 'Tambah Kategori'); ?>
...
</div><?php /**PATH C:\Users\asus\Herd\sistem-pos\resources\views\livewire\category\create-category.blade.php ENDPATH**/ ?>