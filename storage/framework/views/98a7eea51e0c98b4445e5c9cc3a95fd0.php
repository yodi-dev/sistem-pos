                        ...
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="<?php echo e($loop->odd ? 'bg-base-300' : 'bg-base-100'); ?>">
                                ...
                                <td wire:navigate href="<?php echo e(route('unit.product', $product->id)); ?>">
                                    <?php if($product->units->isEmpty()): ?>
                                        <p class="text-xs text-gray-500">Klik untuk menambahkan satuan.</p>
                                    <?php else: ?>
                                        <?php $__currentLoopData = $product->units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span
