...
<?php endif; ?>
                <dialog id="modalCart" class="modal" wire:ignore.self x-data @close-modal.window="modalCart.close()">
                    <div class="modal-box text-base-content bg-base-300 py-3 max-w-2xl">
                        ...
                        <?php else: ?>
                            <?php $__currentLoopData = $groupedCart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div wire:click="selectProduct(<?php echo e($product->id); ?>)"
                        ...
                        <div class="card-body p-4 items-center justify-center">
                            <div class="card-actions">
                                <?php if(collect($cart)->contains(fn($item) => $item['id'] === $product->id)): ?>
            ...
            <?php else: ?>
                <table class="table table-auto w-full border-1 border-neutral shadow">
                    ...
                    <tbody class="text-base-content">
                        <?php $__currentLoopData = $wholesales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wholesale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</div><?php /**PATH C:\Users\asus\Herd\sistem-pos\resources\views\livewire\wholesale\wholesale-manager.blade.php ENDPATH**/ ?>